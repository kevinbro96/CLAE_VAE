...
class BasicBlock(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=False, expansion=0, bn_adv_flag=False, bn_adv_momentum=0.1):
...
class resnet_imagenet(nn.Module):
    ...
    def __init__(self, block, layers, low_dim=128, is_feature=None, bn_adv_flag=False, bn_adv_momentum=0.1):
...
def resnet18_imagenet(low_dim=128, bn_adv_flag=True,bn_adv_momentum=0.1):
    return resnet_imagenet(BasicBlock, [2,2,2,2], low_dim, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)

def resnet34_imagenet(low_dim=128, bn_adv_flag=True, bn_adv_momentum=0.1):
    return resnet_imagenet(BasicBlock, [3,4,6,3], low_dim, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)

def resnet50_imagenet(low_dim=128, bn_adv_flag=True, bn_adv_momentum=0.1):
    return resnet_imagenet(Bottleneck, [3,4,6,3], low_dim, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)

def resnet101_imagenet( low_dim=128, bn_adv_flag=True, bn_adv_momentum=0.1):
    return resnet_imagenet(Bottleneck, [3,4,23,3], low_dim, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)

def resnet152_imagenet(low_dim=128, bn_adv_flag=True, bn_adv_momentum=0.1):
    return resnet_imagenet(Bottleneck, [3,8,36,3], low_dim, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)

class MyResNet(nn.Module):
    def __init__(self, name, low_dim=128, normalize=True, bn_adv_flag=False, bn_adv_momentum=0.01):
        super(MyResNet, self).__init__()
        if name == 'resnet18':
            self.net = resnet_imagenet(BasicBlock, [2,2,2,2], low_dim=128, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)
        elif name == 'resnet34':
            self.net = resnet_imagenet(BasicBlock, [3,4,6,3], low_dim=128, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)
        elif name == 'resnet50':
            self.net = resnet_imagenet(Bottleneck, [3,4,6,3], low_dim=128, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)
        elif name == 'resnet101':
            self.net = resnet_imagenet(Bottleneck, [3,4,23,3], low_dim=128, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)
        elif name == 'resnet152':
            self.net = resnet_imagenet(Bottleneck, [3,8,36,3], low_dim=128, bn_adv_flag=bn_adv_flag, bn_adv_momentum=bn_adv_momentum)
        else:
            raise NotImplementedError('model {} is not implemented'.format(name))

    def forward(self, x, adv=False):
        return self.net(x, adv = adv)
